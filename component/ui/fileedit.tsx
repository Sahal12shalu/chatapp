  ...
  useEffect(() => {
        ...
        const Getmydetails = async () => {
          ...
          if (res.ok) {
            ...
            SetuserData(datas.message.image)
          } else {
            alert('error')
          }
        }
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    return (
      <div className="w-full" {...getRootProps()}>
            ...
            <div className="relative w-full mt-10 max-w-xl mx-auto">
              ...
              {!files && userData ? (
                ...
                <motion.div
                  ...
                  style={{ backgroundImage: files ? `url(${URL.createObjectURL(files)})` : '' }}
                  className={cn(
        ...
        <button onClick={onCancel} className="w-full text-white/70 mt-6 hover:text-white/90 font-semibold">Skip</button>
      </div>
    );
  };
